...
public class RedisConfig {
    ...
    public RedisMessageListenerContainer redisMessageListenerContainer(
        RedisConnectionFactory connectionFactory,
        RedisDirectMessageSubscriber subscriber,
        LiveBoardMatchSubscriber liveBoardMatchSubscriber,
        ...
        container.addMessageListener(
            subscriber,
            new PatternTopic("directRoom:*")
        );

        container.addMessageListener(
            liveBoardMatchSubscriber,
            new PatternTopic("live_board:match:*")
        );

        container.addMessageListener(
            locationSubscriber,
            new PatternTopic("location-channel")
        );
