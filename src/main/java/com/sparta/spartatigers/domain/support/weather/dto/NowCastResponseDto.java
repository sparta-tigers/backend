...
public class NowCastResponseDto {
    ...
    public static NowCastResponseDto of(
        ...
        dto.temperature = (temperature == null || temperature.isNaN())
            ? null
            : temperature;
        dto.skyStatus = skyStatus;
        dto.rainType = rainType;
        dto.rainAmount = (rainAmount == null || rainAmount.isNaN())
            ? null
            : rainAmount;
        dto.rainProbability = rainProbability;
        dto.windSpeed = (windSpeed == null || windSpeed.isNaN())
            ? null
            : windSpeed;
    ...
    public static NowCastResponseDto empty(
        Stadium stadium,
        LocalDateTime referenceTime
    ) {
        NowCastResponseDto dto = new NowCastResponseDto();
