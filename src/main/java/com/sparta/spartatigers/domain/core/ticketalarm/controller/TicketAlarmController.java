package com.sparta.spartatigers.domain.core.ticketalarm.controller;
...
import com.sparta.spartatigers.domain.core.ticketalarm.service.TicketAlarmService;
...
public class TicketAlarmController {
    ...
    public ApiResponse<TicketAlarmResponseDto> createAlarm(
        ...
        return ApiResponse.created(
            ticketAlarmService.createAlarm(userId, request)
        );
    }
    ...
    public ApiResponse<Page<TicketAlarmResponseDto>> getAllAlarms(
        ...
        return ApiResponse.success(
            ticketAlarmService.getAllAlarms(userId, page, size)
        );
    }
    ...
    public ApiResponse<TicketAlarmResponseDto> updateAlarm(
        ...
        Long userId = tokenClaim.getUserId();
        return ApiResponse.success(
            ticketAlarmService.updateAlarm(userId, alarmId, request)
        );
    }
    ...
    @GetMapping("/count")
    public ApiResponse<Long> getAlarmCount(@Auth TokenClaim tokenClaim) {
        Long userId = tokenClaim.getUserId();
