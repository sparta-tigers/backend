...
public record ItemCreateRequest(
    ...
    public record Location(
            ...
            @Min(value = -90, message = "위도는 -90 이상이어야 합니다.") @Max(value = 90, message = "위도는 90 이하이어야 합니다.") @NotNull(message = "위도는 필수입니다.") Double latitude,

            // [FIX] 경도(longitude): 지구 좌표계 기준 -180 ~ +180
            @Min(value = -180, message = "경도는 -180 이상이어야 합니다.") @Max(value = 180, message = "경도는 180 이하이어야 합니다.") @NotNull(message = "경도는 필수입니다.") Double longitude,
