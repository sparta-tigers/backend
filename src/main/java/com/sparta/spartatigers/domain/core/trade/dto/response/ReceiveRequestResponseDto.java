 ...
 *
 * <p>
 * status: 아이템 자체의 상태 (ItemStatus) — REGISTERED, COMPLETED 등
 * <p>
 * exchangeStatus: 교환 요청의 진행 상태 (ExchangeStatus) — PENDING, ACCEPTED, REJECTED,
 * COMPLETED
 * <p>
 * 이 두 필드는 다른 개념이므로 반드시 구분하여 사용해야 합니다.
 * <p>
