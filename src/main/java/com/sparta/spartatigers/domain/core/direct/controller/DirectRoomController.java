...
public class DirectRoomController {
    ...
    public ApiResponse<Page<DirectRoomResponseDto>> getDirectRooms(
        ...
        Page<DirectRoomResponseDto> rooms = directRoomService.getRoomsForUser(
            currentUserId,
            pageable
        );
    ...
    public ApiResponse<DirectRoomItemResponseDto> getDirectRoomItem(
        ...
        Long currentUserId = tokenClaim.getUserId();
        DirectRoomItemResponseDto response = directRoomService.getRoomItem(
            directRoomId,
            currentUserId
        );
    ...
    public ApiResponse<List<DirectRoomMessageResponse>> getMessagesAfter(
        ...
        Long currentUserId = tokenClaim.getUserId();
        List<DirectRoomMessageResponse> messages =
            directRoomService.getMessagesAfter(
                directRoomId,
                timestamp,
                currentUserId,
                pageable
