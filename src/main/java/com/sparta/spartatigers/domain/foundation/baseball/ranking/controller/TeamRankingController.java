package com.sparta.spartatigers.domain.foundation.baseball.ranking.controller;
...
import com.sparta.spartatigers.domain.foundation.baseball.ranking.service.TeamRankingService;
...
public class TeamRankingController {
    ...
    public ApiResponse<List<TeamRankingResponseDto>> getRankingByDate(
        ...
        return ApiResponse.success(
            rankingService.getRankingByDate(anyday, leagueType)
        );
    }
    ...
    public ApiResponse<List<TeamRankingResponseDto>> getRankingByYear(
        ...
        return ApiResponse.success(
            rankingService.getRankingByYear(year, leagueType)
        );
    }
